...
public class StudyDashboard {
    ...
    private static double getRate(final int totalNumberOfEvents, final Participant p) {
    ...
    private String getMarkDownForParticipant(final int totalNumberOfEvents, final Participant p) {
